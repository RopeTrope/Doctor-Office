...
export class DodavanjeLekaraComponent implements OnInit {
  ...
  if(this.ime == "" || this.prezime == "" || this.korisnicko_ime == "" || this.lozinka == ""|| this.adresa == "" || this.imejl == "" ||
  this.specijalizacija == "" || this.ogranak == "" || this.broj_licence == null || this.kontakt == null){
  ...
  if(this.slika == ""){
    this.slika = "data:image/png;base64,";
      ...
      this.userService.dodajLekara(this.ime,this.prezime,this.korisnicko_ime,this.lozinka,this.adresa,this.kontakt,this.imejl,this.slika,
        this.specijalizacija,this.ogranak,this.broj_licence).subscribe()
    this.ime = ""
    this.prezime = ""
    this.korisnicko_ime = ""
    this.lozinka = ""
  ...
  this.convertFile(event.target.files[0]).subscribe(base64 => {
    ...
    this.slika = "data:image/png;base64," + this.base64Output;
