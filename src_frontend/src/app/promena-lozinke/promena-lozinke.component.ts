...
export class PromenaLozinkeComponent implements OnInit {
  ...
  promeniLozinku(){
    ...
    if(br && spec && velika && mala && prvo){
      this.error = ""
      this.userService.dohvatiKorisnika(this.korisnik,this.old_pass).subscribe((u:Pacijent)=>{
        if(u){
          this.userService.azurirajSifru(this.korisnik,this.new_pass).subscribe();
